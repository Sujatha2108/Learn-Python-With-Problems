...
# 🧠 Learn-Python-With-Problems – A 50-Day Problem Solving Journey 🚀
...
> **Solved:** 4 / 100 &nbsp;&nbsp; ![Progress](https://progress-bar.dev/0/?scale=100&title=Completed&width=300)
...
|-----|---------------------------------------------|--------------------------------------------|-------------|
| 1   | Print "Hello, World!"                      | [Day01_Print_Hello_World.py](Day01_Print_Hello_World.py) |  ✅ completed    |
...
| 11  | Armstrong Number Check                     | [Day11_Armstrong_Number.py](Day11_Armstrong_Number.py) | ✅ completed       |
| 12  | Print All Primes Between 1 to 100          | [Day12_Print_Primes_1_to_100.py](Day12_Print_Primes_1_to_100.py) | ✅ completed     |
...
| 59  | Convert Two Lists into a Dictionary        | [Day59_Lists_to_Dict.py](Day59_Lists_to_Dict.py) | ✅ completed|
| 60  | Extract Unique Values from List of Dictionaries | [Day60_Unique_Values_from_List_of_Dicts.py](Day60_Unique_Values_from_List_of_Dicts.py) |✅ completed |
